...
"""
  for i in range(0,60):
    ipp = "10.0.0.10" + str(i)
    macc = "00:00:00:00:11:0" + str(i)
    while len(switches) is 16:
      continue
    sww = random.choice(switches.keys())
    
    swdpid = dpid_to_str(sww)
    if swdpid == "00-00-00-00-00-01":
      portt = 4
    if swdpid == "00-00-00-00-00-02":
      portt = random.choice([3,4])
    if swdpid == "00-00-00-00-00-03":
      portt = random.choice([3,4])
    if swdpid == "00-00-00-00-00-04":
      portt = random.choice([2,3,4])
    if swdpid == "00-00-00-00-00-05":
      portt = 4
    if swdpid == "00-00-00-00-00-06":
      portt = 4
    if swdpid == "00-00-00-00-00-07":
      portt = random.choice([2,3,4])
    if swdpid == "00-00-00-00-00-08":
      portt = random.choice([2,3,4])
    if swdpid == "00-00-00-00-00-09":
      portt = random.choice([2,4])
    if swdpid == "00-00-00-00-00-10":
      portt = 4
    if swdpid == "00-00-00-00-00-11":
      portt = 4
    if swdpid == "00-00-00-00-00-12":
      portt = 4
    if swdpid == "00-00-00-00-00-13":
      portt = random.choice([2,3,4])
    if swdpid == "00-00-00-00-00-14":
      portt = random.choice([2,3,4])
    if swdpid == "00-00-00-00-00-15":
      portt = random.choice([2,3,4])
    if swdpid == "00-00-00-00-00-16":
      portt = random.choice([2,3,4])
    mac_map[EthAddr(mac)] = (sww, swdpid) 
"""
