...
def adjustthread():
  ...
  while True:
    ...
    if keyspeed < 10 and keystate is not 1 and socketbegin is True:
      s = socket.socket(socket.AF_INET, socket.SOCK_STREAM)    
      port=50972
      s.connect(("10.0.0.111",port))
      s.send('0'+'#'+'2'+'#'+'d4:3d:7e:67:59:5a'+'#'+'10.0.0.55')
    ...
    if keyspeed >= 10 and keyspeed <60 and keystate is not 2 and socketbegin is True:
      s = socket.socket(socket.AF_INET, socket.SOCK_STREAM)    
      port=50972      
      s.connect(("10.0.0.111",port))
      s.send('0'+'#'+'1'+'#'+'d4:3d:7e:67:59:5a'+'#'+'10.0.0.55')
      #s.send(str(GID)+'#'+str(FID)+'#'+'00:00:00:00:00:11'+'#'+'11.11.11.1')
    ...
    if keyspeed >= 60 and keystate is not 3 and socketbegin is True:
      s = socket.socket(socket.AF_INET, socket.SOCK_STREAM)    
      port=50972       
      s.connect(("10.0.0.111",port))
      s.send('0'+'#'+'0'+'#'+'d4:3d:7e:67:59:5a'+'#'+'10.0.0.55')
      #s.send(str(GID)+'#'+str(FID)+'#'+'00:00:00:00:00:11'+'#'+'11.11.11.1')
...
def run2():
  ...
  for i in range(1,21):
    ...
    if i is 15 or i is 16:
      sww = swv[11]
      if i is 15:
        portt = 4
      else:
        portt = 3
    if i is 17 or i is 9:
      sww = swv[12]
      if i is 9:
        portt = 4
      else:
        portt = 3
    if i is 18 or i is 19:
      sww = swv[13]
      if i is 18:
        portt = 3
      else:
        portt = 4
    if i is 20 or i is 10:
      sww = swv[14]
      if i is 10:
        portt = 4
      else:
