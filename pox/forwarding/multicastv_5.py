...
def adjustthread():
  ...
  while True:
    ...
    if keyspm < 10 and keystate is not 1 and socketbegin is True and keyvalue is 1:
      ...
      s.send('0'+'#'+'2'+'#'+'00:1e:4f:92:25:23'+'#'+'10.0.0.33')
    ...
    if keyspm >= 10 and keyspm <40 and keystate is not 2 and socketbegin is True and keyvalue is 1:
      """
      if keystate is 2:
        keycounter = keycounter +1
      else:
      ...
      port=50972      
      s.connect(("10.0.0.111",port))
      s.send('0'+'#'+'1'+'#'+'00:1e:4f:92:25:23'+'#'+'10.0.0.33')
      #s.send(str(GID)+'#'+str(FID)+'#'+'00:00:00:00:00:11'+'#'+'11.11.11.1')
    ...
    if keyspm >= 40 and keystate is not 3 and socketbegin is True:
      """
      if keystate is 3:
        keycounter = keycounter +1
      else:
      ...
      port=50972       
      s.connect(("10.0.0.111",port))
      s.send('0'+'#'+'0'+'#'+'00:1e:4f:92:25:23'+'#'+'10.0.0.33')
      #s.send(str(GID)+'#'+str(FID)+'#'+'00:00:00:00:00:11'+'#'+'11.11.11.1')
