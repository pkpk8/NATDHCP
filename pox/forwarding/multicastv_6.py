...
def adjustthread():
  ...
  while True:
    ...
    print keyvalue
    print '%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%'
    if keyspm < 5 and keystate is not 1 and socketbegin is True and keyvalue is 1:
      """
      if keystate is 1:
      ...
      s.send('0'+'#'+'2'+'#'+'d4:3d:7e:67:59:33'+'#'+'10.0.0.60')
    ...
    if keyspm >= 5 and keyspm <20 and keystate is not 2 and socketbegin is True and keyvalue is 1:
      """
      if keystate is 2:
        keycounter = keycounter +1
      else:
      ...
      port=50972      
      s.connect(("10.0.0.111",port))
      s.send('0'+'#'+'1'+'#'+'d4:3d:7e:67:59:33'+'#'+'10.0.0.60')
      #s.send(str(GID)+'#'+str(FID)+'#'+'00:00:00:00:00:11'+'#'+'11.11.11.1')
      print '%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%'
    ...
    if keyspm >= 20 and keystate is not 3 and socketbegin is True:
      """
      if keystate is 3:
        keycounter = keycounter +1
      else:
      ...
      port=50972       
      s.connect(("10.0.0.111",port))
      s.send('0'+'#'+'0'+'#'+'d4:3d:7e:67:59:33'+'#'+'10.0.0.60')
      print '%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%'
...
def run2():
  ...
  for i in range(1,21):
    ...
    if i is 15 or i is 16 or i is 18 or i is 19:
      sww = swv[11]
      if i is 15:
        portt = 4
      else:
        portt = 3
    if i is 17 or i is 9 or i is 20 or i is 10:
      sww = swv[12]
      if i is 9:
        portt = 4
      else:
